    ...
    render: function() {
      return (
        React.createElement("div", null, 
          ...
          React.createElement("h3", null, "I am a full stack web developer")
        )
      );
    }
  });
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var Point = React.createClass({displayName: "Point",
    render: function() {
      ...
      return (
        React.createElement("div", null, 
          React.createElement("p", {onClick: this.props.click, target: "_blank", "data-toggle": "collapse", "data-target": this.props.toggle, style: styles.text}, " ", React.createElement("a", {href: this.props.url}, this.props.text), " ", React.createElement("span", {className: "pull-right"}, this.props.date)), 
